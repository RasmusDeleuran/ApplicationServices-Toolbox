...
# 1.0		2018.01.22	rahd       	Initial version created
# 1.1		2018.01.22	rahd       	Added functions CheckConnection, TestPort, TestShare
# 1.2		2018.01.23	rahd       	Modified function GetUpTime
# 1.3		2018.01.25	rahd       	Added function CheckDiskSpace
# 1.4		2018.02.07	rahd       	Added functions StartIISSite, StopIISSite, CheckIISSite
# 1.5		2018.02.12	rahd       	Added function TestSQLConnection
# 1.6		2018.02.13	rahd       	Modified function TestPort
# 1.7		2018.02.14	rahd       	Modified functions CheckConnection, CheckDiskSpace, StartIISSite, StopIISSite
# 1.7.1		2018.02.15	rahd        	Added Greeting message
# 1.8		2018.02.16	rahd       	Added function CheckProcess
#
########################################################################################################################
# CURRENT VERSION: 1.8
########################################################################################################################
...
Write-Host "Current Version: 1.8" -ForegroundColor Yellow
